# Lean Canvas - FinGuard AI

> **1-Page Business Model Summary**
...
```
 ...
 SCENARIUL ALES: BOOTSTRAPPED              1. Subscription Model (primary):
 ────────────────────────────                 - Starter: 49 RON/lună (freelanceri începători)
 Fixed Costs (lunar):                         - Professional: 99 RON/lună (freelanceri activi)
 - Infrastructure + APIs: 2.300-7.000 RON     - Business: 199 RON/lună (SRL micro, agenții)
   (Railway, Vercel, Claude API, R2)          - Free tier: 0 RON (trial 30 zile, lead gen)
 - Marketing & Ads: 1.000-3.000 RON
 - Juridic & Admin: 500-1.000 RON          2. Future Revenue Streams (post-MVP):
 - Salarii: 0 RON (founders EQUITY)           - API access pentru contabili/agenții (B2B)
                                              - White-label solution pentru platforme
 Total lunar: ~4.000-12.000 RON               - Affiliate: bănci, platforme freelancing
 Total An 1: ~130.000 RON                     - Premium add-ons: banking, plăți online

 ALTERNATIV: FUNDED SCENARIO               Proiecție An 1 (conservativă):
 - Infrastructure + APIs: 2.300-7.000         - Luna 1-3: ~0-930 RON/lună (beta)
 - Salarii 6 membri: 37.000-40.000 RON        - Luna 4-6: ~1.700-5.200 RON/lună (early)
   (CTO 15k, Backend 12k, Frontend 10k)       - Luna 7-12: ~9.000-45.800 RON/lună (scaling)
 - Marketing: 2.000-5.000 RON
...
Freelancerii și micii antreprenori români petrec 8-12 ore pe lună cu managementul financiar și fiscal, un proces manual, predispus la erori, și stresant. Alternativele existente (Excel, Smartbill, sau angajarea unui contabil) sunt fie ineficiente, fie scumpe, fie nu oferă optimizare fiscală proactivă.
...
Integrare directă cu ANAF (e-Factura) asigură acuratețe și conformitate.

### Unique Value Proposition

> "Finanțele tale, automate și optimizate"

Primul și singurul asistent AI financial specializat pentru legislația fiscală românească. Transformă managementul financiar dintr-o corvoadă de 10+ ore/lună într-un proces pasiv de 10 minute/lună.

### Unfair Advantage

- **AI specialized**: Deep knowledge al Codului Fiscal RO (CAS, CASS, impozit, deduceri)
- **First-mover**: Primul AI-first solution pentru freelanceri RO
- **Tech expertise**: Echipă cu experiență AI/ML
- **Integrare ANAF**: Direct access e-Factura și SPV
...
- **SAM** (Serviceable Addressable Market): ~300.000
  - Freelanceri cu venit >3.000 RON/lună (pot plăti SaaS)
- **SOM** (Serviceable Obtainable Market) An 1: 1.500-3.000 utilizatori
...
**Proiecție An 1**: ~160.000 RON (conservator)
...
- **Salarii: 0 RON** (6 founders lucrează pe equity vesting)
...
**Break-even (bootstrapped)**: Luna 9-10
**ROI An 1 (bootstrapped)**: ~23%

### Key Metrics

- **Acquisition**:
  - CAC (Customer Acquisition Cost): <300 RON/client
  - Free → Paid conversion: 40% target după trial
- **Engagement**:
  - Avg 15 documents processed/user/lună
  - Active monthly users (MAU) target growth
- **Retention**:
  - Churn rate <10%/lună (SaaS benchmark: <5% ideal)
  - Monthly Recurring Revenue (MRR) growth
- **Economics**:
  - LTV (Lifetime Value): 1.200-2.400 RON (assuming 12-24 months retention)
  - LTV:CAC ratio: 4-8:1 (healthy: >3:1)
  - Gross margin: ~60-70% (after variable costs)
- **Value Delivered**:
  - Avg tax saved per user: 500-2.000 RON/an
  - Time saved: 8-12 hours/lună → ~10 minutes/lună

---

## 💡 Notă Importantă: Salariile Echipei

### Scenariul BOOTSTRAPPED (Ales)
...
**Tranziție la salarii**: După break-even + 3-6 luni cash buffer (estimat luna 12-15)

### Scenariul FUNDED (Alternativ)
...
- Marketing/Growth: ~3.000-8.000 RON/lună part-time → full-time

**Total payroll**: ~37.000-45.000 RON/lună (~444k-540k/an)
...
**Tool**: Template Lean Canvas (Ash Maurya)
**Status**: Living document - se actualizează quarterly

---

## Export & Usage

**Pentru prezentări**: Export PNG/PDF de aici
**Pentru business plan**: Include în [BUSINESS_FOUNDATION.md](./BUSINESS_FOUNDATION.md)
**Pentru pitch deck**: Slide dedicat cu canvas vizual

**Tool recomandat pentru vizualizare**: [Canvanizer](https://canvanizer.com/new/lean-canvas) sau [LeanStack](https://leanstack.com/lean-canvas)
