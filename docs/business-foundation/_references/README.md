# [BOOKS] References - Material Original

> **Documente de referință - NU MODIFICA**

Acest folder conține materialele originale pentru proiect: idea inițială, cerințe profesor, și exemple de la studenți din anii anteriori.
...
- Business Foundation ca deliverable

**Când să consulți**: Pentru a te asigura că rămâi aligned cu viziunea originală
...
- Secțiunile obligatorii:
  ...
  - Motivație (max ½ pg)
  - Rezumat (½-1 pg)
  - SWOT, Market Analysis, Tehnologii, Riscuri
  - Planificare + Gantt (OBLIGATORIU!)
  - Costuri + Model business + ROI
  - Lean Canvas
- **Important**: "Puteți folosi cât mai multe tooluri de AI, dar să menționați explicit unde ați folosit și cum (prompturile)."

**Când să consulți**: Înainte de finalizare, pentru a verifica că ai toate secțiunile cerute
...
- Costurile lor sunt OUTDATED (2023-2024, nu 2026)
...
- [NO] Nu copia text
- [NO] Nu refolosi prețurile lor (sunt vechi!)
- [NO] Nu ignora diferențele de cerințe
...
[NO] **Nu copia** text sau secțiuni direct
[NO] **Nu refolosit** estimările lor de costuri (outdated!)
[NO] **Nu presupune** că exemplele sunt "perfecte" (pot avea lipsuri)
[NO] **Nu ignora** noile cerințe (AI tools documentation!)
[NO] **Nu folosi** aceleași competitori fără research propriu

---

## [OK] Ce Să Faci

[OK] **Inspiră-te** din structură și depth
[OK] **Benchmark** calitatea analizei tale vs. a lor
[OK] **Verifică** că ai toate secțiunile pe care le au ei (și mai multe)
[OK] **Research** propriile date actualizate (2025-2026)
[OK] **Documentează** AI usage (ei nu aveau asta, tu DA!)
...
**[TARGET] Folosește exemplele ca benchmark de calitate, NU ca template de copiat!**
