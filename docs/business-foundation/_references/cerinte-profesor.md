# Cerințe Business Foundation

> **Management de Produs și Antreprenoriat - Universitatea București**
...
- **Probabilitate**: Cât de probabil să apară?
- **Planuri de răspuns**: Cum mitigezi?
- **Optional**: Costuri asociate riscului
...
## [AI] Cerință Specială: Utilizare AI Tools
...
- Ce output ați obținut
- Cum v-a ajutat

**Vezi**: [`../_plan/ai-usage-log.md`](../_plan/ai-usage-log.md) pentru documentare
...
- [ ] Motivație (max ½ pg)
- [ ] Rezumat (½-1 pg)
- [ ] Analiza SWOT completă
- [ ] Market Analysis + Matrice funcționalități
- [ ] Tehnologii folosite (max 1 pg)
- [ ] Riscuri cu planuri de răspuns
- [ ] Echipa definită
- [ ] **Diagrama Gantt** (obligatoriu!)
- [ ] Categorii costuri + estimări
- [ ] Model business + estimări venituri
- [ ] ROI + Payback period
- [ ] Lean Canvas (1-page)
- [ ] **Documentare AI tools cu prompturi**

---

**Source**: Cerințe profesor MPA - UBB
**Data**: 2026
